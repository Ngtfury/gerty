...
class ImageCommands(commands.Cog):
    ...
    async def emojify(self, ctx, object: typing.Union[discord.Member, discord.PartialEmoji, discord.Message, str]=None):
    ...
    async def hearts(self,ctx, object: typing.Union[discord.Member, discord.PartialEmoji, discord.Message, str]=None):
        await ctx.trigger_typing()
    ...
    async def equation(self, ctx, object: typing.Union[discord.Member, discord.PartialEmoji, discord.Message, str]=None):
        await ctx.trigger_typing()
        time1=time.perf_counter()
        if object==None:
            if ctx.message.reference:
    ...
    async def boil(self, ctx, object: typing.Union[discord.Member, discord.PartialEmoji, discord.Message, str]=None):
        await ctx.trigger_typing()
        time1=time.perf_counter()
        if object==None:
            if ctx.message.reference:
    ...
    @commands.command(brief='image', description='Rotates an image (gif)', usage='[user or custom emoji or url]', aliases=['rotate'])
    async def roll(self, ctx, object: typing.Union[discord.Member, discord.PartialEmoji, discord.Message, str]=None):
        await ctx.trigger_typing()
        time1=time.perf_counter()
        if object==None:
            if ctx.message.reference:
        ...
        async with aiohttp.ClientSession() as session:
            async with session.get(f'https://api.jeyy.xyz/image/roll?image_url={_url}') as r:
                if r.status != 200:
                    return await ctx.send(embed=Utils.BotEmbed.error(f'Sorry there was an error, {r.reason}'))
                buf=BytesIO(await r.read())
        time2=time.perf_counter()
