...
class Rtfm(commands.Cog):
    ...
    @commands.group(brief='rtfm', description='Gives you a documentation link according your query', aliases=['rtfd', 'rtdm'], usage='[sub command]', invoke_without_command=True)
