...
class Paginator:
    ...
    async def start(self):
        ...
        while True:
            ...
            try:
                event=await self.bot.wait_for('button_click', check=lambda i: i.channel==self.ctx.channel and i.component.id in ['ButtonLeft', 'ButtonRight'], timeout=self.timeout)
